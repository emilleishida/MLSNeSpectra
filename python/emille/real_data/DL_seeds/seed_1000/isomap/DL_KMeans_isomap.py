...
# path to DL results
path_small_space = '../out/out_120,100,90,50,30,20,3,20,30,50,90,100,120_seed1000_dl.dat'

# path to spectra ID
path_id = '../../../../../../data_all_types/spectra_data.dat'

# path to kmeans result
path_kmeans = '../cl_data/clustering_KMeans_label_3PC_2groups.dat'
...
plt.tight_layout()
plt.savefig("seed1000_3f_2g_kmeans_wang_isomap.pdf", format='pdf',dpi=1000)
