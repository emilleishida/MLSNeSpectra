...
# path to DL results
path_small_space = '../out/out_120,100,90,50,30,20,5,20,30,50,90,100,120_seed5000_dl.dat'
...
plt.tight_layout()
plt.savefig("seed1000_5f_2g_kmeans_wang_isomap.pdf", format='pdf',dpi=1000)
