...
color_branch[2]['color'] = ['red', 'orange', 'blue', 'green']
...
for j in xrange(len(branch_code)):
    legs[j] = plt.scatter(matrix[branch_code[j],0], matrix[branch_code[j],0], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,5)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],0], matrix[branch_code[j],1], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,6)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],1], matrix[branch_code[j],1], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,9)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],0], matrix[branch_code[j],2], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,10)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],1], matrix[branch_code[j],2], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,11)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],2], matrix[branch_code[j],2], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,13)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],0], matrix[branch_code[j],3], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,14)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],1], matrix[branch_code[j],3], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,15)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],2], matrix[branch_code[j],3], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
plt.subplot(4,4,16)
for j in xrange(len(branch_code)):
    plt.scatter(matrix[branch_code[j],3], matrix[branch_code[j],3], lw='0',marker=color_branch[2]['mark'][j],s=14, color=color_branch[2]['color'][j])
...
fig.legend([legs[1], legs[0], legs[2], legs[3]], [color_branch[2]['name'][1],color_branch[2]['name'][0], color_branch[2]['name'][2], color_branch[2]['name'][3]], loc = (0.807, 0.735), title='Branch classification', fontsize=18)
plt.show()
