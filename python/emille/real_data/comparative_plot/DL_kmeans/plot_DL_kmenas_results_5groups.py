...
panels.append(plt.scatter(matrix[group5,0], matrix[group5,0], lw='0',marker=mark[4],s=24, color=c[4]))
...
plt.scatter(matrix[group5,0], matrix[group5,1], lw='0',marker=mark[4],s=14, color=c[4])
...
plt.scatter(matrix[group5,1], matrix[group5,1], lw='0',marker=mark[4],s=14, color=c[4])
plt.xticks([])
plt.yticks([])
...
plt.scatter(matrix[group5,0], matrix[group5,2], lw='0',marker=mark[4],s=14, color=c[4])
...
plt.scatter(matrix[group5,1], matrix[group5,2], lw='0',marker=mark[4],s=14, color=c[4])
plt.xticks([])
plt.yticks([])
...
plt.scatter(matrix[group5,2], matrix[group5,2], lw='0',marker=mark[4],s=14, color=c[4])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.scatter(matrix[group5,0], matrix[group5,3], lw='0',marker=mark[4],s=14, color=c[4])
...
plt.scatter(matrix[group3,1], matrix[group3,3], lw='0',marker='s',s=14, color=c[2])
plt.scatter(matrix[group4,1], matrix[group4,3], lw='0',marker='d',s=14, color=c[3])
plt.scatter(matrix[group5,1], matrix[group5,3], lw='0',marker='*',s=14, color=c[4])
...
plt.scatter(matrix[group3,2], matrix[group3,3], lw='0',marker='s',s=14, color=c[2])
plt.scatter(matrix[group4,2], matrix[group4,3], lw='0',marker='d',s=14, color=c[3])
plt.scatter(matrix[group5,2], matrix[group5,3], lw='0',marker='*',s=14, color=c[4])
...
plt.scatter(matrix[group3,3], matrix[group3,3], lw='0',marker='s',s=14, color=c[2])
plt.scatter(matrix[group4,3], matrix[group4,3], lw='0',marker='d',s=14, color=c[3])
plt.scatter(matrix[group5,3], matrix[group5,3], lw='0',marker='*',s=14, color=c[4])
...
fig.legend(panels, ['Group 1', 'Group 2', 'Group 3', 'Group 4', 'Group 5'], loc = (0.798, 0.77), title='Kmeans classfication', fontsize=18)
plt.show()
