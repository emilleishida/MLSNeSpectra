...
path_kmeans = '../../DL_kmeans/cl_data_all/clustering_KMeans_label_4PC_4groups.dat'
...
panels[0] = plt.scatter(Y[group1, 0], Y[group1, 1], color=c[0], marker=mark[0], s=22)
panels[1] = plt.scatter(Y[group2, 0], Y[group2, 1], color=c[1], marker=mark[1], s=14)
panels[2] = plt.scatter(Y[group3, 0], Y[group3, 1], color=c[2], marker=mark[2], s=14)
panels[3] = plt.scatter(Y[group4, 0], Y[group4, 1], color=c[3], marker=mark[3], s=20)
legs=fig1.legend(panels, ['Group 1', 'Group 2', 'Group 3', 'Group 4'], loc = (0.0, 0.794), title='Kmeans classfication', fontsize=16)
plt.setp(legs.get_title(),fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.xlim(-2.0, 2.0)
plt.ylim(-1.5, 2.0)
plt.xlabel('isomap 1', fontsize=18)
plt.ylabel('isomap 2', fontsize=18)
...
legs2=fig2.legend(panels2, names, loc = (0.0, 0.755), title='Wang classification', fontsize=16)
plt.setp(legs2.get_title(),fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.tight_layout()
plt.xlim(-2.0, 2.0)
...
plt.savefig("kmeans_wang_isomap.eps", format='eps',dpi=1000)
