...
path_kmeans = '../../DL_kmeans/cl_data_all/clustering_KMeans_label_4PC_3groups.dat'
...
legs=fig1.legend(panels, ['Group 1', 'Group 2', 'Group 3'], loc = (0.0, 0.854), title='Kmeans classfication', fontsize=22)
...
plt.tight_layout()
plt.savefig("kmeans_wang_isomap_3g.pdf", format='pdf',dpi=1000)
