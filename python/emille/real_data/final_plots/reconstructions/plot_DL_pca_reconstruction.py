...
plt.subplot(1,2,1)
plt.plot(wavelenght_array_flux, flux[17], color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[175] + 1.5, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[1794] + 3.0, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[26] + 4.5, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[108] + 6.0, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[1401] + 7.5, color='black', lw=1.0)
...
plt.text(3600, 1.15, 'SN%s \n %.1fd' % (spectra_data['f0'][17][2:],spectra_data['f3'][17]))
plt.text(3600, 1.15 + 1.5, 'SN%s \n %.1fd' % (spectra_data['f0'][175][2:],spectra_data['f3'][175]))
plt.text(3600, 1.15 + 2.75, 'SN%s \n %.1fd' % (spectra_data['f0'][1794][2:],spectra_data['f3'][1794]))
plt.text(3600, 1.15 + 4.0, 'SN%s \n %.1fd' % (spectra_data['f0'][26][2:],spectra_data['f3'][26]))
plt.text(3600, 1.15 + 5.5, 'SN%s \n %.1fd' % (spectra_data['f0'][108][2:],spectra_data['f3'][108]))
plt.text(3600, 1.15 + 7.0, 'SN%s \n %.1fd' % (spectra_data['f0'][1401][2:],spectra_data['f3'][1401]))
...
line,  = axs.plot(wavelenght_array_flux, flux[47], color='black', label=names[0], lw=1.0)
plt.plot(wavelenght_array_flux, flux[3174] + 1.0, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[1646] + 2.0, color='black', lw=1.0)
plt.plot(wavelenght_array_flux, flux[2240] + 3.0, color='black', lw=1.0)
...
plt.text(3600, 1.15, 'SN%s \n %.1fd' % (spectra_data['f0'][47][2:],spectra_data['f3'][47]))
plt.text(3600, 1.15 + 1.0, 'SN%s \n %.1fd' % (spectra_data['f0'][3174][2:],spectra_data['f3'][3174]))
plt.text(3600, 1.15 + 2.0, 'SN%s \n %.1fd' % (spectra_data['f0'][1646][2:],spectra_data['f3'][1646]))
plt.text(3600, 1.15 + 3.0, 'SN%s \n %.1fd' % (spectra_data['f0'][2240][2:],spectra_data['f3'][2240]))
