...
names = []
for j in [1,0,2,3]:
    legs[j] = plt.scatter(matrix[wang_code[j],0], matrix[wang_code[j],0], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],0], matrix[wang_code[j],1], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
plt.subplot(4,4,6)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],1], matrix[wang_code[j],1], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,9)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],0], matrix[wang_code[j],2], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
plt.subplot(4,4,10)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],1], matrix[wang_code[j],2], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,11)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],2], matrix[wang_code[j],2], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
plt.xticks([])
plt.yticks([])
plt.xlim(-1.5, 1.5)
plt.ylim(-1.5, 1.5)
...
plt.subplot(4,4,13)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],0], matrix[wang_code[j],3], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
plt.subplot(4,4,14)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],1], matrix[wang_code[j],3], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
plt.subplot(4,4,15)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],2], matrix[wang_code[j],3], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
plt.subplot(4,4,16)
for j in xrange(len(wang_code)):
    plt.scatter(matrix[wang_code[j],3], matrix[wang_code[j],3], lw='0',marker=my_marks[j],s=14, color=my_colors[j])
...
legend = fig.legend(legs, names, loc = (0.764, 0.764), title='Wang classification', fontsize=18)
