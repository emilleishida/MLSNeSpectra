...
for i in range(2,11,1):
    ...
    variances_table.append([i,var_fraction_pca_no_TL, var_fraction_pca_TL, var_fraction_DL_no_TL, var_fraction_DL_TL])

savetxt('./residuals.dat', variances_table, header='nPCs fraction_variance_PCA_at_max fraction_variance_PCA_with_TL fraction_variance_DL_at_max fraction_variance_DL_with_TL'   )



data_to_plot = loadtxt('./residuals.dat').T
figure()
plot(data_to_plot[0], data_to_plot[1],'xr')
plot(data_to_plot[0], data_to_plot[2],'Dr')
plot(data_to_plot[0], data_to_plot[3],'xk')
plot(data_to_plot[0], data_to_plot[4],'Dk')
